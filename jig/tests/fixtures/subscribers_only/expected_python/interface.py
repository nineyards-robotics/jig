...
T = TypeVar("T", bound=SubscribersOnlySession)


class _SubscribersOnlyNode(jig.BaseNode[T]):
    ...
    def _destroy_entities(self, sn: T) -> None:
        ...
        sn.subscribers.camera_image._destroy(sn.node)
