    ...
    class ParamListener:
        ...
        def update(self, parameters):
            ...
            for param in parameters:
                if param.name == self.prefix_ + "namespace":
                    updated_params.namespace = param.value
        ...
        def declare_params(self):
            ...
            if not self.node_.has_parameter(self.prefix_ + "namespace"):
                descriptor = ParameterDescriptor(description="Topic namespace", read_only = True)
                parameter = updated_params.namespace
                self.node_.declare_parameter(self.prefix_ + "namespace", parameter, descriptor)
