...
T = TypeVar("T", bound=PublishersOnlySession)


class _PublishersOnlyNode(jig.BaseNode[T]):
    ...
    def _create_session(self, node) -> T:
        ...
        sn.publishers.counter._initialise(sn, Int32, "counter", QoSProfile(history=HistoryPolicy.KEEP_LAST, depth=5, reliability=ReliabilityPolicy.BEST_EFFORT))
    ...
    def _destroy_entities(self, sn: T) -> None:
        ...
        sn.publishers.counter._destroy(sn.node)
