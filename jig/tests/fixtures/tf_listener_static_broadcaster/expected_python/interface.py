...
@dataclass
class TfListenerStaticBroadcasterSession(jig.Session, Generic[SessionT]):
...
T = TypeVar("T", bound=TfListenerStaticBroadcasterSession)


class _TfListenerStaticBroadcasterNode(jig.BaseNode[T]):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            "tf_listener_static_broadcaster",
            session_type,
            on_configure,
...
def run(
    ...
    *,
    ...
    wrapper = _TfListenerStaticBroadcasterNode(
        session_type,
        on_configure,
        on_activate=on_activate,
        on_deactivate=on_deactivate,
