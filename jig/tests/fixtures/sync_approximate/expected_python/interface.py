...
@dataclass
class SyncApproximateSession(jig.Session[SessionT]):
...
T = TypeVar("T", bound=SyncApproximateSession)


class _SyncApproximateNode(jig.BaseNode[T]):
