...
@dataclass
class TfBroadcasterStaticBroadcasterSession(jig.Session):
...
T = TypeVar("T", bound=TfBroadcasterStaticBroadcasterSession)


class _TfBroadcasterStaticBroadcasterNode(jig.BaseNode[T]):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            "tf_broadcaster_static_broadcaster",
            session_type,
            on_configure,
...
def run(
    ...
    *,
    ...
    wrapper = _TfBroadcasterStaticBroadcasterNode(
        session_type,
        on_configure,
        on_activate=on_activate,
        on_deactivate=on_deactivate,
